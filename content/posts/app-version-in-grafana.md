...
date: 2019-02-18T14:00:28+01:00
description: >
...
certain business-critical topics.
...
cluster and started to build dashboards the metrics.
...
`build_info`. This metric provides some metadata about the current build in the
form of labels and has a constant value of `1`:
...
> running. This is not an A/B test.
...
[Grafana supports series
overrides](http://docs.grafana.org/v5.3/features/panels/graph/#series-overrides),
